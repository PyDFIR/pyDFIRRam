...
def set_up_logging(
    ...
    if console_log_output == "stdout":
        ...
        print("LOGGER ERROR: Failed to set console output: invalid output: '%s'"
              % console_log_output)
        return False
    ...
    try:
        ...
        print("LOGGER ERROR: Failed to set console log level: invalid level: '%s'"
              % console_log_level)
        return False
    ...
    try:
        ...
        print("LOGGER ERROR: Failed to set up log file log level: invalid level: '%s'"
              % logfile_log_level)
        return False
